...
{
    public class FileBrowserController : MerchantTribeStore.Controllers.Shared.BaseAdminController
    {
        ...
        private BreadCrumbViewModel BuildBreadCrumbs(string path)
        {
            ...
            while (finished == false)
            {
                ...
                {
                    Link = Url.Content("~/bvadmin/filebrowser?path=" + workingPath),
                    Name = dir,
                    Title = dir
                });
            ...
            items.Add(new BreadCrumbItem()
            {
                Link = Url.Content("~/bvadmin/filebrowser"),
                Name = "Root",
                Title = "Root"
            });
        ...
        public ActionResult CreateDirectory()
        {
            ...
            string destination = Url.Content("~/bvadmin/filebrowser?path=" + path);
