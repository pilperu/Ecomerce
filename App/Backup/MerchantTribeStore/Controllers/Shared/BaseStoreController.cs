...
namespace MerchantTribeStore.Controllers.Shared
{
    ...
    public class BaseStoreController : BaseAppController
    {
        protected override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            ViewData["siteheader"] = header; // MerchantTribe.Commerce.Utilities.TagReplacer.ReplaceContentTags(header, MTApp, itemCount, Request.IsSecureConnection);
            ...
            ViewData["sitefooter"] = footer; // MerchantTribe.Commerce.Utilities.TagReplacer.ReplaceContentTags(footer, MTApp, itemCount, Request.IsSecureConnection);
